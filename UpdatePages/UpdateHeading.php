...
if(!isset($_COOKIE['id']))
    header('Location: ../UpdatePages/Choose_Heading.php');

if (!R::testConnection())
    exit ('Нет соединения с базой данных');

$info = '';
$heading = R::findOne('heading','id = ?', array($_COOKIE['id']));
...
$past_title = $heading->title;
$past_parent_id = $heading->parent_id;
$past_book_title = $heading->book_title;
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    unset($past_title);
    unset($past_parent_id);
    unset($past_book_title);
...
<head>
    ...
    <title>Update Heading Page</title>
...
<div class="container" style="margin-top: 80px">
    <?php echo $info; $info = '';?>
    <h2 class="text-center text-light">Update heading</h2>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-12">
                ...
                <input value="<?php echo @$past_title ?>" type="text" maxlength="100" name="title" class="form-control" id="title" placeholder="Title name" required>
            </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-6">
                ...
                <input value="<?php echo @$past_parent_id?>" type="number" name="parent_id" class="form-control" id="parent_id" placeholder="Parent id" required>
            </div>
