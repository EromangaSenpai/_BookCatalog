...
if(!isset($_COOKIE['id']))
    header('Location: ../UpdatePages/Choose_Author.php');

if (!R::testConnection())
    exit ('Нет соединения с базой данных');

$info = '';
$author = R::findOne('author','id = ?', array($_COOKIE['id']));
...
$past_name = $author->name;
$past_type = $author->publisher_book;

if($_SERVER['REQUEST_METHOD'] == 'POST')
{

    $author->name = $_POST['authorName'];
    $author->publisher_book = $_POST['type'];
...
<div class="container" style="margin-top: 80px">
    <?php echo $info; $info = '';?>
    <h2 class="text-center text-light">Update author</h2>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-6">
                ...
                <input value="<?php echo @$past_name ?>" type="text" maxlength="90" name="authorName" class="form-control" id="authorName" placeholder="Author name" required>
            </div>
